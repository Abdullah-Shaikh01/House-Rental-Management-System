...
public class ShowAvailableHouse {
        public JFrame frame;
        public ShowAvailableHouse() {
        frame = new JFrame("House Details");
        ...
        JButton addHouse = new JButton("Rent a House");
        ...
        JButton delHouse = new JButton("Back");
    ...
    private int lastCustomerId() {
         try {
                ...
                System.out.println("Connection established");
                    PreparedStatement stmt = conn.prepareStatement("SELECT id FROM customer_details ORDER BY id DESC LIMIT 1");
    ...
    private Object[][] getHouseDetails() {
        ...
        final String QUERY = "SELECT * FROM house_details WHERE Availability='Available'";
